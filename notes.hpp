...
#define EIGHTH           12
#define SIXTEENTH       6
#define THIRTY_SECOND  3
#define SIXTY_FOURTH  1
...
#define NTM(note) (unsigned int)(((60000.0 / (double)TEMPO) * note) / 4.0)

#define DSN(type, freq, durr, spv,vol) {1,type, freq,durr, spv, vol,0}
